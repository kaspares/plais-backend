    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CurrentMembers", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExecutiveMembers", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FoundingMembers", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BulletinPhoto", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BulletinPhoto_Bulletins_BulletinId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ExecutiveMemberId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CadenceMemberships", x => new { x.ExecutiveMemberId, x.CadenceId });
                    table.ForeignKey(
                        name: "FK_CadenceMemberships_Cadences_CadenceId",
                        column: x => x.CadenceId,
                        principalTable: "Cadences",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CadenceMemberships_ExecutiveMembers_ExecutiveMemberId",
                        column: x => x.ExecutiveMemberId,
                        principalTable: "ExecutiveMembers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ResourceGroups_ResourceCategories_ResourceCategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ResourceItems_ResourceGroups_ResourceGroupId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BulletinPhoto_BulletinId",
                table: "BulletinPhoto",
                column: "BulletinId");

            migrationBuilder.CreateIndex(
                name: "IX_CadenceMemberships_CadenceId",
                table: "CadenceMemberships",
                column: "CadenceId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ResourceGroups_ResourceCategoryId",
                table: "ResourceGroups",
                column: "ResourceCategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_ResourceItems_ResourceGroupId",
                table: "ResourceItems",
